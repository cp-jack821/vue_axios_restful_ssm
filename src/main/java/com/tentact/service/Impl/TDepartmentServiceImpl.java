...
public class TDepartmentServiceImpl implements TDepartmentService {
     ...
     */
    @Override
    public PageInfo<TDepartment> getDept(Integer pageNum, Integer pageSize) {

        //        查询到的集合
        List<TDepartment> list = tDepartmentMapper.findDept();
...
//        System.out.println("list = " + list);
//        真的分页
        PageInfo<TDepartment> pageInfo = new PageInfo<>(list,pageSize);
